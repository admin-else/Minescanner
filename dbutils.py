...
def addPing(pingdict):
    ...
    INSERT INTO test VALUES
        (?, ?, ?, ?, ?, ?, ?, ?)
    """, (str(time.time_ns()),pingdict['ip'],str(pingdict['version']['protocol']),str(pingdict['players']['max']),getSavePingDescription(pingdict['description'])[0],str(int(getSavePingDescription(pingdict['description'])[1])),stripString(pingdict['version']['name']),int('forgeData' in pingdict),))

    conn.commit()


addPing(pingdictping)